...
## prompt1: 심층 분석 및 보고 ##
# reasoning
# doc ./prompts/web3_projects/theoriq.txt
현재단계: prompt1
...
지시사항:
웹 검색 활용: 신뢰할 수 있는 출처(공식 웹사이트, 기술 문서, GitHub, 주요 언론, X 등)에서 오늘 날짜를 기준으로 최신 정보를 찾기 위해 반드시 웹 검색 기능을 사용해야 함. **중요: 주어진 기초 정보(project info)의 프로젝트만을 검색할것, 다른 프로젝트일거라고 추정하고 가정하지말것**
...
- 3000천자 내외로 작성
- 중요: 구조와 스타일 참고용이며 예시 형식에 나온 프로젝트의 내용을 참고하라는 뜻은 아님
- 중요: 출력물1의 결과에 출력물2의 섹션을 적당히 스스로 추가/삭제 하여야함
